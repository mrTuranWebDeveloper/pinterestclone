...
urlpatterns = [
    ...
    path('comment-upvotes/', create_comment_upvote, name='create_comment_upvote'),
    path('get-comment-upvote-count/<int:comment_id>/', get_comment_upvote_count, name='get_comment_upvote_count'),
